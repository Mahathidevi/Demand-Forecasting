...
API_TOKEN = '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'
...
def download_pdf():
    ...
    model_paths = {
        'Cetirizine': {
            'rating': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Cetirizine_rating_new.joblib',
            'sales': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Cetirizine_new.joblib',
            'uses': "relieving allergy symptoms such as hay fever, sneezing, runny nose, and itchy eyes"
        },
        'Diclofenac': {
            'rating': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Diclofenac_rating_new.joblib',
            'sales': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Diclofenac_new (1).joblib',
            'uses': "treating pain and inflammation, particularly in conditions like arthritis"
        },
        'Aspirin': {
            'rating': r'C:\Users\mahat\Downloads\Demand web\models\rating_forecast_model.joblib',
            'sales': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Aspirin_new.joblib',
            'uses': "relieving pain, reducing fever, and acting as an anti-inflammatory"
        },
        'Paracetamol': {
            'rating': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Paracetamol_rating_new.joblib',
            'sales': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Paracetamol_NEW (1).joblib',
            'uses': "relieving pain and reducing fever"
        },
        'Zolpidem': {
            'rating': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Zolpidem_rating_new.joblib',
            'sales': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Zolpidem.joblib',
            'uses': "treating insomnia and helping with sleep initiation"
        },
        'Benzodiazepines': {
            'rating': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Benzodiazepines_rating_new.joblib',
            'sales': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Benzodiazepines.joblib',
...
def forecast():
    if request.method == 'POST':
        ...
        # Load the appropriate model and generate forecasts
        model_paths = {
            'Cetirizine': {
                'rating': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Cetirizine_rating_new.joblib',
                'sales': r'C:\Users\mahat\Downloads\Demand web\models\sarimax_model_Cetirizine_new.joblib',
